...
public class PharmacyOrderDetailsAdapter extends RecyclerView.Adapter<PharmacyOrderDetailsAdapter.ViewHolder> {
    private List<MedicineDetail> listOfMedicines;
    ...
    public PharmacyOrderDetailsAdapter( List<MedicineDetail> listOfMedicines, Context context, String type) {
    ...
    @Override
    public PharmacyOrderDetailsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PharmacyOrderDetailsAdapter.ViewHolder(itemView);
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(final PharmacyOrderDetailsAdapter.ViewHolder holder, final int position) {
