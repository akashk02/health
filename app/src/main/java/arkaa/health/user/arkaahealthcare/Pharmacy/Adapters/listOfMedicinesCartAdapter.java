...
public class listOfMedicinesCartAdapter extends RecyclerView.Adapter<listOfMedicinesCartAdapter.ViewHolder> {
    ...
    public listOfMedicinesCartAdapter( List<MedicineDetail> listOfMedicines, Context context, String type) {
    ...
    @Override
    public listOfMedicinesCartAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        Log.v("pharmacycartbeta1","onBindViewHolder");
