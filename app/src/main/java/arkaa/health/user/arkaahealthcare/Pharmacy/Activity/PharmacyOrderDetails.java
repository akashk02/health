...
public class PharmacyOrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacy_order_details_beta);
        ...
        uploadPrescriptionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PharmacyOrderDetails.this, ListOfPrescription.class);
            ...
            public void onClick(View v) {
                ...
                if (!bookingIntentType.equals("uploadPrescription")) {
                    ...
                    if(validate()) {
                        ...
                        Intent intent = new Intent(PharmacyOrderDetails.this, PharmacyCart.class);
        ...
        if (requestCode == PRESCRIPTION_RESULT) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if(prescriptionId != null){
                    Toast.makeText(PharmacyOrderDetails.this,"Prescription Uploaded Successfully",Toast.LENGTH_SHORT).show();
                }
    ...
    public void assignLabAppointmentPostObjectValue() {
        ...
        pharmacyOrderMedicinePost.setPaymentTypeId("1");
...
//        pharmacyOrderMedicinePost.setPaymentStatusId("3");
    ...
    public PharmacyOrderMedicinePost getPharmacyOrderPrescriptionObject() {
        ...
        pharmacyPrescriptionOrderMedicinePost.setPaymentTypeId("1");
...
//        pharmacyPrescriptionOrderMedicinePost.setPaymentStatusId("3");
        ...
        return pharmacyPrescriptionOrderMedicinePost;
...
//        Call<Post> postList = News_Api.getService().reqRescreateUser(url,loginPost);
        ...
        final Call<PharmacyOrderMedicineResponse> postList = listOfPharmacyApi.getService().PharmacyOrderMedicineApi(token, url, getPharmacyOrderPrescriptionObject());
        ...
        postList.enqueue(new Callback<PharmacyOrderMedicineResponse>() {
            ...
            public void onResponse(Call<PharmacyOrderMedicineResponse> call, Response<PharmacyOrderMedicineResponse> response) {
                ...
                if (postList1.getSuccess() == true) {
                    ...
                    String patientName = pharmacyPrescriptionOrderMedicinePost.getName();
                    String patientUniqueId = pharmacyPrescriptionOrderMedicinePost.getUserUid();
                    String pharmacyUniqueId = pharmacyPrescriptionOrderMedicinePost.getPharmacyUid();
                    ...
                    Toast.makeText(PharmacyOrderDetails.this, "Please enter correct username/password", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<PharmacyOrderMedicineResponse> call, Throwable t) {
                ...
                Toast.makeText(PharmacyOrderDetails.this, "No Network, Please check your internet connection", Toast.LENGTH_SHORT).show();
    ...
    public boolean validate() {
        ...
        if (address.isEmpty()) {
            patientAddressEditText.setError("Please Enter Address");
            valid = false;
        } else {
        ...
        if(prescriptionId.equals("null")){
            Toast.makeText(PharmacyOrderDetails.this,"Please Upload Prescription",Toast.LENGTH_SHORT).show();
            valid = false;
...
//                .show();
        ...
        new AwesomeSuccessDialog(this)
                ...
                .setPositiveButtonClick(new Closure() {
                    ...
                    public void exec() {
                        //click
                        Intent i = new Intent(PharmacyOrderDetails.this, FragmentActivity.class);
