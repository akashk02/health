...
public class LabReviewTestAdapterBeta extends RecyclerView.Adapter<LabReviewTestAdapterBeta.ViewHolder> {
//    private List<String> labTestsArrayList;
    ...
    public LabReviewTestAdapterBeta(List<Test> listOfTests) {
